...
--- Per-token animation interface acquired via `token.animation`. Provides spawn primitives (Light / Billboard / PlayEffect), transform control (Tween / SetVisible), and a sound passthrough. Spawns made during a scripted animation are tracked and stopped when the animation ends.
