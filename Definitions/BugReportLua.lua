...
--- An in-progress bug report created with dmhub.BeginBugReport(). Holds the screenshot captured when the report was begun and can upload the report with Submit.
--- @class BugReportLua
...
function BugReportLua:Submit(options) end
