...
--- @field blockChangesWhenEditing boolean If set to true, setting @see text in code will fail if the user is editing the text.
--- @field resetOnDeActivation boolean (default=true) When false, the current selection stays highlighted after the editor loses focus (e.g. to a find bar's search field).
--- @field placeholderAlpha number The alpha value of placeholder text. (default=0.6)
...
--- @field textNoNotify nil|string An alias of @see text, but if set, no events will fire on the panel.
--- @field editlag nil|number When the text is edited, the lag before calling the 'edit' event.
...
--- @field multiline nil|boolean (default=true) Multiline editor.
--- @field verticalScrollbar nil|boolean (default=false) If true, a vertical scrollbar is shown when content overflows.
...
--- @field selectionAnchorPosition nil|number The opposite bounds of the selection from @see caretPosition.
--- @field blockChangesWhenEditing nil|boolean If set to true, setting @see text in code will fail if the user is editing the text.
--- @field placeholderAlpha nil|number The alpha value of placeholder text. (default=0.6)
TextEditorArgs = {}
