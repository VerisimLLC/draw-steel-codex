...
--- Deprecated Lua interface for DM sheet HUD operations. Use LuaInterface instead.
--- @class editor
...
function editor:FillTerrain(val) end

--- Opens the mod settings dialog.
function editor:ShowModSettingsDialog() end

--- Sets a custom map tool to be used temporarily. Returns an event source that fires a 'tool' event with the MapPath created by the tool, or nil if the HUD is unavailable.
