...
--- Represents a set of dice with a specific model, color, and optional variables.
--- @class DiceSetLua
...
--- Returns the video effect with the given id, or nil if not found.
--- @param id? string
--- @return DiceVideoEffect
function DiceSetLua.GetEffect(id) end
