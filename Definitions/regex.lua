...
--- Provides regex pattern matching and replacement utilities. All patterns are case-insensitive.
--- @class regex
regex = {}
...
--- Finds all matches of a pattern in a string and returns a table of match group tables.
--- @param str string The string to match against.
--- @param pattern string The regex pattern.
--- @return string[][] A table of matches, where each match is a table of capture group strings.
function regex.MatchAll(str, pattern) end

--- Replaces the first occurrence of a regex pattern in the input string with the replacement string.
--- @param input? string
--- @param pattern? string
--- @param replacement? string
--- @return string
function regex.ReplaceOne(input, pattern, replacement) end

--- Replaces all occurrences of a regex pattern in the input string with the replacement string.
--- @param input? string
--- @param pattern? string
--- @param replacement? string
--- @return string
function regex.ReplaceAll(input, pattern, replacement) end

--- Splits a string by a regex pattern and returns a table of substrings.
